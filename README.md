...
2.	Clique em <i>Sign Up</i>, crie uma conta, você vai receber um email para a ativação clique no <i>link</i> enviado para ativar sua conta.<BR /><BR />
...
d.	<i>Handler registration</i>: ttn-handler-brazil.<BR />
   e.	Clique em <i>Add aplication</i>.</p></div><BR /><BR />
